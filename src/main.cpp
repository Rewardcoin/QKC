...
const string strMessageMagic = "QukuaiCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "QukuaiCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1455897600;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1429646 : 1429646;

        //// debug print
        assert(block.hashMerkleRoot == uint256("0x648998dedc65392c33edb56d9dea7e12fa6d3c881839522fbbf0b537dc4d917b"));
...
unsigned char pchMessageStart[4] = { 0x75, 0x30, 0x27, 0x50 };
